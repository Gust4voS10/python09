...
def main() -> None:
    print("=============================")
    try:
        crew1: list[Any] = [CrewMember(member_id="C2026A",
                                       name="Ana Silva",
                                       rank=Rank.commander,
                                       age=42,
    ...
    try:
        crew2: list[Any] = [CrewMember(member_id="C3002A",
        ...
        for member in mission2.crew:
            mb_name: str = member.name
            mb_rank: str = member.rank.name.capitalize()
            mb_spec: str = member.specialization
            print(f" - {mb_name} ({mb_rank}) - {mb_spec}")
    except ValidationError as e:
        print(e.errors()[0]["msg"][13:])
